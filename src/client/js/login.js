...
document.addEventListener("DOMContentLoaded", function () {
        ...
        fetch('/api/verify-reset-code', {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    codigoError.textContent = data.message || "Código inválido. Por favor, verifica e intenta nuevamente.";
                }
            })
            .catch(error => {
                console.error('Error:', error);
    ...
    nuevaPasswordForm.addEventListener("submit", function (e) {
        ...
        if (newPassword.length < 8) {
            ...
            newPasswordError.textContent = "La contraseña debe incluir mayúsculas, minúsculas, números y símbolos";
            return;
        } else {
        ...
        fetchWithTimeout('/api/login', {
            ...
            .catch(error => {
                ...
                if (error.message === 'Tiempo de espera agotado') {
                    mostrarModal("La solicitud ha tardado demasiado. Por favor, verifica tu conexión e intenta nuevamente.", false);
                } else {
                    mostrarModal("Información de inicio de sesión incorrecta", false);
                }
                // Reiniciar el captcha
